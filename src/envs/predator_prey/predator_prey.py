# modified from ma-gym: https://github.com/koulanurag/ma-gym/tree/master/ma_gym/envs
...
class PredatorPrey(gym.Env):
    ...
    def __init__(self, grid_shape=(5, 5), n_agents=2, n_preys=1, prey_move_probs=(0.175, 0.175, 0.175, 0.175, 0.3),
        ...
        self.observation_space = spaces.Tuple([spaces.Box(self._obs_low, self._obs_high) for _ in range(self.n_agents)])
    ...
    def step(self, agents_action):
        ...
        return self.get_agent_obs(), rewards, self._agent_dones, truncated, {'prey_alive': self._prey_alive}
...
gym.register(
    "PredatorPrey",
    entry_point="envs.predator_prey.predator_prey.PredatorPrey",
    kwargs={
        "grid_shape": 10,
        "n_agents": 8,
        "n_preys": 8,
