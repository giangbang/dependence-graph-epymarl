...
class DeepCoordinationGraphMAC(BasicMAC):
    ...
    def __init__(self, scheme, groups, args):
        ...
        self.utility_fun = self._mlp(self.args.hidden_dim, args.cg_utilities_hidden_dim, self.n_actions)
        payoff_out = 2 * self.payoff_rank * self.n_actions if self.payoff_decomposition else self.n_actions ** 2
        self.payoff_fun = self._mlp(2 * self.args.hidden_dim, args.cg_payoffs_hidden_dim, payoff_out)
